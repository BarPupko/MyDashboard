            ...
            {sortedDays.length === 0 ? (
              ...
              sortedDays.map((day) => (
                ...
                >
                  ...
                  >
                    {day.overtimeMinutes !== 0
                      ? `${day.overtimeMinutes > 0 ? "+" : ""}${day.overtimeMinutes}`
                      : "-"}
                  </td>
                    ...
                    {day.notes ? (
                      <Tooltip.Provider delayDuration={200}>
                        <Tooltip.Root>
                          ...
                          <Tooltip.Portal>
                            <Tooltip.Content
                              className="bg-gray-900 text-white px-3 py-2 rounded text-xs shadow-lg max-w-[300px] whitespace-pre-wrap"
                              sideOffset={5}
                            >
                              {day.notes}
                              <Tooltip.Arrow className="fill-gray-900" />
